                ...
                <div class="theme-about1 wp-clearfix">
                    <div class="theme-info1">
                        <div class="mtdi-leftsidewrap">
                            <h2 class="theme-name"><?php echo esc_html($plugin_name); ?><span
                                        class="theme-version"><?php printf(esc_html__('Version: %1$s', 'mysterythemes-demo-importer'), $theme_version); ?></span>
                            </h2>
                                ...
                                <?php if (isset($required_plugins) && !empty($required_plugins)) : ?>
                                    <table class="plugins-list-table widefat striped">
                                        ...
                                        foreach ($required_plugins as $key => $value):
                                            ...
                                            ?>
                                            <tr class="mtdi-plist-section mtdi-plist plugin-card-<?php echo esc_attr($key); ?>"
                                                data-slug="<?php echo esc_attr($key); ?>"
                                                data-init="<?php echo esc_attr($value['slug']); ?>"
                                                data-name="<?php echo esc_attr($value['name']); ?>">
                                                <td class="plugin-name">
                                                    <a href="<?php echo esc_url('//wordpress.org/plugins/') . esc_attr($key); ?>"
                                                       target="_blank"><?php echo esc_html($value['name']); ?></a>
                                                </td>
                                                <td class="plugin-status">
                                                    <a disabled="disabled"
                                                       class="<?php echo esc_attr($button_classes); ?> instalplugin1 alignright mtdi-<?php echo esc_attr($key); ?>" <?php if (isset($value['install'])) echo 'data-install="' . esc_html($value['install']) . '"'; ?>
                                                       data-init="<?php echo esc_attr($value['slug']); ?>"
                                                       data-slug="<?php echo esc_attr($key); ?>"
                                                       data-name="<?php echo esc_attr($value['name']); ?>"><?php echo esc_html($button_text); ?></a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                        </tbody>
                            ...
                            <div class="nextstep" style="display: none;">
                                <table class="plugins-list-table widefat striped">
                                    ...
                                    <tr class="item-list">
                                        <td class="plugin-name">
                                            <a href="#"
                                               target="_blank"><?php esc_html_e('Import XML Data', 'mysterythemes-demo-importer'); ?></a>
                                        </td>
                                        <td class="plugin-status">
                                    ...
                                    <tr class="item-list">
                                        <td class="plugin-name">
                                            <a href="#"
                                               target="_blank"><?php esc_html_e('Import Customizer Settings', 'mysterythemes-demo-importer'); ?></a>
                                        </td>
                                        <td class="plugin-status">
                                            <i class="fa fa-close"></i>
                                            <i class="fa fa-tick"></i>
                                    ...
                                    <tr class="item-list">
                                        <td class="plugin-name">
                                            <a href="#"
                                               target="_blank"><?php esc_html_e('Import Widgets', 'mysterythemes-demo-importer'); ?></a>
                                        </td>
                                        <td class="plugin-status">
                                            <i class="fa fa-close"></i>
                                            <i class="fa fa-tick"></i>
                        ...
                        <p class="description">
                            <input type="hidden" class="count_plugins"
                                   value="<?php echo absint(count($required_plugins)); ?>">
                        ...
                        <div class="demo-import-actions">
                            ...
                            if ($totalcount != $latestcount) {
                                ?>
                                <a class="button button-hero button-primary hide-if-no-js mtdi-install-setup" href="#"
                                   data-name="<?php echo esc_attr($plugin_name); ?>"
                                   data-slug="<?php echo esc_attr($theme_slug); ?>"
                                   data-plugins="<?php echo esc_attr($json_plugin_lists); ?>"><?php esc_html_e('Install & Activate', 'mysterythemes-demo-importer'); ?></a>
                                <a class="button button-hero button-primary hide-if-no-js mtdi-demo-import-step"
                                   href="#" data-name="<?php echo esc_attr($plugin_name); ?>"
                                   data-slug="<?php echo esc_attr($theme_slug); ?>"
                                   data-plugins="<?php echo esc_attr($json_plugin_lists); ?>"
                                   data-execution="<?php echo esc_attr($execution_time); ?>"
                                   style="display: none;"><?php esc_html_e('Import Demo Now', 'mysterythemes-demo-importer'); ?></a>
                            <?php } else { ?>
                                <a class="button button-hero button-primary hide-if-no-js mtdi-install-setup" href="#"
                                   data-name="<?php echo esc_attr($plugin_name); ?>"
                                   data-slug="<?php echo esc_attr($theme_slug); ?>"
                                   data-plugins="<?php echo esc_attr($json_plugin_lists); ?>"
                                   style="display: none;"><?php esc_html_e('Install & Activate', 'mysterythemes-demo-importer'); ?></a>
                                <a class="button button-hero button-primary hide-if-no-js mtdi-demo-import-step"
                                   href="#" data-name="<?php echo esc_attr($plugin_name); ?>"
                                   data-slug="<?php echo esc_attr($theme_slug); ?>"
                                   data-plugins="<?php echo esc_attr($json_plugin_lists); ?>"
                                   data-execution="<?php echo esc_attr($execution_time); ?>"><?php esc_html_e('Import Demo Now', 'mysterythemes-demo-importer'); ?></a>
                                <a class="button button-hero button-primary mtdi-customize-button hide-if-no-js"
                                   href="<?php echo esc_url(admin_url('customize.php')); ?>" target="_blank"
                                   style="display: none"><?php esc_html_e('Customize Site', 'mysterythemes-demo-importer'); ?></a>
                            <?php } ?>
                            <textarea style="display: none;"
                                      id="hidden_plugin_lists-<?php echo esc_attr($theme_slug); ?>"><?php echo esc_attr($json_plugin_lists); ?></textarea>
                        </div><!-- .demo-import-actions -->
                    </div><!-- .theme-info1 -->
                    <div class="theme-screenshots1">
                        <div class="screenshot">
                            <iframe id="demoiframe" src="<?php echo esc_url($demo_url); ?>"></iframe>
                            <img id="loadingMessage"
                                 src="<?php echo esc_url(MTDI_PLUGIN_URL . '/admin/images/ajax-loader.gif'); ?>"/>
                        </div>
